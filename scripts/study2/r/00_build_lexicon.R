...
#   • Identity Status (Marcia, 1966)
#   • Social Cognitive Career Theory (Lent et al., 1994)
#   • Career Indecision literature (Germeijs & Verschueren, 2006)
...
#   • Place a pre-trained GloVe or FastText .txt file in data/embeddings/
...
message('✅ Lexicon files written to results/study2/') 